...
class PhysicalConstants {
  ...
  private:
    ...
    static constexpr parthenon::Real gravitational_constant_cgs = 6.67408e-08; //cm**3/(g*s**2)
    //static constexpr parthenon::Real gravitational_constant_cgs = 6.67384e-08; //cm**3/(g*s**2)
    ...
    parthenon::Real code_mass_cgs() const {
     return code_mass_cgs_; 
    } 
    parthenon::Real code_time_cgs() const {
  ...
  public:
    ...
    parthenon::Real kev() const { 
      return kev_cgs/code_energy_cgs(); 
    }
    parthenon::Real g() const { 
      return g_cgs/code_mass_cgs(); 
    }
    parthenon::Real cm() const { 
