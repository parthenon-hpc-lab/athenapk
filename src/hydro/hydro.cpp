...
#include "../recon/mixed_plm_wenoz.hpp"
...
std::shared_ptr<StateDescriptor> Initialize(ParameterInput *pin) {
  ...
  if (recon_str == "dc") {
    ...
    recon_need_nghost = 3;
  } else if (recon_str == "mixed_plm_wenoz") {
    recon = Reconstruction::mixed_plm_wenoz;
    recon_need_nghost = 3;
  ...
  add_flux_fun<Fluid::glmmhd, Reconstruction::mixed_plm_ppm, RiemannSolver::hlle>(
      flux_functions);
  add_flux_fun<Fluid::glmmhd, Reconstruction::mixed_plm_wenoz, RiemannSolver::hlle>(
      flux_functions);
  ...
  add_flux_fun<Fluid::glmmhd, Reconstruction::mixed_plm_ppm, RiemannSolver::hlld>(
      flux_functions);
  add_flux_fun<Fluid::glmmhd, Reconstruction::mixed_plm_wenoz, RiemannSolver::hlld>(
      flux_functions);
