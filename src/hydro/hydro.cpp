...
std::shared_ptr<StateDescriptor> Initialize(ParameterInput *pin) {
  ...
  if (recon_str == "dc") {
    ...
    recon_need_nghost = 3;
  } else if (recon_str == "ppm_va") {
    recon = Reconstruction::ppm_va;
    recon_need_nghost = 3;
  ...
  add_flux_fun<Fluid::euler, Reconstruction::ppm_va, RiemannSolver::hlle>(flux_functions);
  ...
  add_flux_fun<Fluid::euler, Reconstruction::ppm_va, RiemannSolver::hllc>(flux_functions);
  ...
  add_flux_fun<Fluid::glmmhd, Reconstruction::ppm_va, RiemannSolver::hlle>(flux_functions);
  ...
  add_flux_fun<Fluid::glmmhd, Reconstruction::ppm_va, RiemannSolver::hlld>(flux_functions);
