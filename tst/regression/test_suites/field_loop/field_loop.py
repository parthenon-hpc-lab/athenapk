...
class TestCase(utils.test_case.TestCaseAbs):
    def Prepare(self,parameters, step):
        ...
        assert parameters.num_ranks <= 2, "Use <= 2 ranks for field loop test or update block sizes."
    ...
    def Analyse(self,parameters):
        ...
        fig, p = plt.subplots(len(method_cfgs), 2,
        ...
        fig.savefig(os.path.join(parameters.output_path, "field_loop.png"),
                    bbox_inches='tight')
