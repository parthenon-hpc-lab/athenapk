...
init_cond_cfgs = [
    [1.0, 0.75, 1.0, 0.125, 0.0, 0.1, 0.5, 0.2, "Sod with right shock,\nright contact,\nleft sonic rarefaction"],
...
class TestCase(utils.test_case.TestCaseAbs):
    ...
    def Analyse(self,parameters):
        ...
        fig, p = plt.subplots(3, len(init_cond_cfgs), figsize = (3 * len(init_cond_cfgs), 8.0))
        ...
        fig.savefig(os.path.join(parameters.output_path, "shock_tube.png"),
