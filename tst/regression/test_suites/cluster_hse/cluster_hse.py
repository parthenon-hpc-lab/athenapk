...
class TestCase(utils.test_case.TestCaseAbs):
    ...
    def Prepare(self,parameters, step):
        ...
        parameters.driver_cmd_line_args = [
                ...
                f"problem/cluster/hydrostatic_equilibrium/K_0={self.K_0.in_units('code_length**4*code_mass/code_time**2').v}",
                f"problem/cluster/hydrostatic_equilibrium/K_100={self.K_100.in_units('code_length**4*code_mass/code_time**2').v}",
                f"problem/cluster/hydrostatic_equilibrium/R_K={self.R_K.in_units('code_length').v}",
                f"problem/cluster/hydrostatic_equilibrium/alpha_K={self.alpha_K}",
